...
window.addEvent('domready', function(){
	$('wysiwyg').mooEditable({
		actions: 'uppercase bold italic underline strikethrough | formatBlock justifyleft justifyright justifycenter justifyfull | insertunorderedlist insertorderedlist indent outdent insertHorizontalRule | undo redo | createlink unlink | urlimage | toggleview'
	});
});
...
this.MooEditable = new Class({
	...
	options: {
		...
		xhtml : true,
		semantics : true,
		actions: 'bold italic underline strikethrough | formatBlock insertunorderedlist insertorderedlist indent outdent | undo redo | createlink unlink | urlimage | toggleview',
		handleSubmit: true,
		handleLabel: true,
		disabled: false,
	...
	render: function(){
		...
		this.textarea.addClass('mooeditable-textarea');
...
MooEditable.UI.Toolbar= new Class({
	...
	initialize: function(options){
		this.setOptions(options);
		this.el = new Element('div', {'id': 'wysiwyg-toolbar'});
		this.el.addClass('mooeditable-ui-toolbar' + this.options['class']);
		this.items = {};
		this.content = null;
	},
...
MooEditable.UI.MenuList = new Class({
	...
	disable: function(){
		if (this.disabled) return;
		this.disabled = true;
		this.el.set('disabled', true).addClass('disabled');
	},
